...
session_start();
    ...
    switch ($_GET["op"])
    {
        case 'guardaryeditar':
            ...
            if(empty($idusuario))
            {
                $rspta=$usuario->insertar($nombre, $tipoDocumento, $numDocumento, $direccion, $telefono, $email, $cargo, $login, $clavehash, $imagen, $_POST['permiso']);
                echo $rspta?"Usuario Registrado":"No se pudieron registrar todos los datos del usuario";
            }
            else
            {
                $rspta=$usuario->editar($idusuario,$nombre, $tipoDocumento, $numDocumento, $direccion, $telefono, $email, $cargo, $login, $clavehash, $imagen, $_POST['permiso']);
        ...
        case 'permisos':
            ...
            //Almacenar los permisos almacenados al usuario en el arreglo
        ...
        case 'verificar':
            ...
            if(isset($fetch))
            {
                ...
                //Declaración de arreglo para almacenar todos los permidos marcados
                $valores=array();
                //Almacenamiento de los permisos en el arreglo
                    while($per=$marcados->fetch_object())
                    {
                        array_push($valores, $per->idPermiso);
                    }
