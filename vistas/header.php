...
<html>
  <head>
    ...
    <title>SSI GR Chía - Depachos</title>
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="index2.html" class="logo">
          ...
          <span class="logo-mini"><b>SSI</b>Despachos</span>
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <span class="hidden-xs">David Bustos Pulido</span>
                </a>
                <ul class="dropdown-menu">
                  ...
                  <li class="user-header">
                    ...
                    <p>
                      www.dvdsoftsolutions.net - Desarrollando Software
                      <small>https://www.youtube.com/channel/UCILK9vfXTNGp0K0NPPZECaw</small>
                    </p>
                  </li>
