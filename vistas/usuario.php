<?php
//Activación del almacenamiento en el Boffer
                    ...
                    <div class="panel-body" id="formularioregistros">
                        <form name="formulario" id="formulario" method="post">
                            ...
                            <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                ...
                                <select class="form-control selectpicker" name="tipoDocumento" id="tipoDocumento" required data-live-search="true">
                            ...
                            <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <label>Número(*):</label>
                                <input type="text" class="form-control" name="numDocumento" id="numDocumento" maxlength="100" placeholder="Documento" required>
                            </div>
                            <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
